 ...
 */
export declare type ExecutableOptions = MakeOptional<{
    action: string;
    params: any[];
 ...
 */
export declare type StoreOptions = MakeOptional<{
    name: string;
    isCachable: boolean;
...
export declare type StateObserverOptions = {
    name: string;
};
/**
 ...
 */
export declare type DecoratorOptions = MakeOptional<{
    store: string | Store;
    name: string;
    state: State;
}, 'name' | 'state'>;
 ...
 * of a store object
 */
export declare type ChangeState = {
    newState: any;
    previousState: any;
};
/**
